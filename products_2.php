...
INNER JOIN flowers ON inventory.flower_id = flowers.id
WHERE (inventory.Date IS NULL OR inventory.Date >= DATE_SUB(NOW(), INTERVAL 5 DAY));";
...
if(mysqli_num_rows($result) > 0){
	...
	echo'	 <div class = "products">';
       ...
       echo'	         <h1 class = "lg-title">FRESH FLOWERS</h1>';
       
   
        echo'	        <h4 align="middle" style="color :#FFC0CB">Perfect for every occassion</h4>';
                   ...
                   echo'	     <div class = "product-info">';
                      echo'	      <div class = "product-info-top">';
                        ...
                        echo'	            <span><i class = "fas fa-star"></i></span>';
                         ...
                         echo'	   <p class = "product-price">$ 150.00</p>';
...
{ 
    ...
    $query = "INSERT INTO cart (product_code, quantity, username) VALUES ($product_id, 1, '$name') ON DUPLICATE KEY UPDATE quantity = quantity + 1 "; 
    // Execute the query 
    $result = mysqli_query($dbconn, $query);
